...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/audio_platform_info_19101.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_19101.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info_19125.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_19125.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info_19700.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_19700.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info_19751.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_19751.xml \
    ...
    $(LOCAL_PATH)/configs/audio/mixer_paths_19101.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_19101.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_19101_dmic.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_19101_dmic.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_19125.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_19125.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_19125_dmic.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_19125_dmic.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_19700.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_19700.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_19700_dmic.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_19700_dmic.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_19751.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_19751.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_19751_dmic.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_19751_dmic.xml \
    ...
    $(LOCAL_PATH)/configs/audio/sound_trigger_mixer_paths_19101.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sound_trigger_mixer_paths_19101.xml \
    $(LOCAL_PATH)/configs/audio/sound_trigger_mixer_paths_19125.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sound_trigger_mixer_paths_19125.xml \
    $(LOCAL_PATH)/configs/audio/sound_trigger_mixer_paths_19700.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sound_trigger_mixer_paths_19700.xml \
    $(LOCAL_PATH)/configs/audio/sound_trigger_mixer_paths_19751.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sound_trigger_mixer_paths_19751.xml \
...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/android.software.nfc.beam.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.software.nfc.beam.xml \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/wifi/bdwlan_19101.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_19101.bin \
    $(LOCAL_PATH)/configs/wifi/bdwlan_19125.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_19125.bin \
    $(LOCAL_PATH)/configs/wifi/bdwlan_19501.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_19501.bin \
    $(LOCAL_PATH)/configs/wifi/bdwlan_19521.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_19521.bin \
    $(LOCAL_PATH)/configs/wifi/bdwlan_19751.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_19751.bin \
    $(LOCAL_PATH)/configs/wifi/bdwlan_20620.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_20620.bin \
...
# Inherit vendor
$(call inherit-product, vendor/realme/RMX2051CN/RMX2051CN-vendor.mk)